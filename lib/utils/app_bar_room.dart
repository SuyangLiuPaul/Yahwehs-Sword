...
///
/// 2026-09-21, from a photo of an older reader's phone running Yahweh's
/// Words — ported here with the same number, because the owner asked for
/// both apps (「sword words相关其他page也是」). The search
...
/// Measured on Words' pushed search page at that width, the field was
/// 36 px with both conveniences on the bar and is 132 px without them. 380 is the line because it keeps
