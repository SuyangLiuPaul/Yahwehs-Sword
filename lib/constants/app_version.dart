...
/// identical. New `import 'package:yahwehs_sword/constants/build_flags.dart'`
...
const String _envAppVersion = String.fromEnvironment(
  'APP_VERSION',
  defaultValue: '1.6.325',
);
const String kAppVersion = _envAppVersion == '' ? '1.6.325' : _envAppVersion;
...
const String kAppReleaseTime = String.fromEnvironment(
  'APP_RELEASE_TIME',
  defaultValue: '2026-09-21T01:55:42Z',
);
